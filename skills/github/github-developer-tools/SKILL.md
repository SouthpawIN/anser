...
description: "Complete GitHub integration: auth, repository management, branch/PR lifecycle, code review, issue tracking, and codebase metrics."
author: Hermes Agent
version: 1.0.0
license: MIT
tags: ["Umbrella", "Developer Tools", "GitHub", "Consolidated"]
related_skills: ["codebase-inspection", "github-auth", "github-code-review", "github-issues", "github-pr-workflow", "github-repo-management"]
---

# GitHub Developer Tools Umbrella

Consolidates all agent-created GitHub integration skills into a single discovery unit.

## Overview

This umbrella covers the full GitHub development workflow:

- **Authentication** — credentials, SSH keys, token handling
- **Repository Management** — clone, create, fork, manage remotes, releases
- **Branch & PR Workflow** — create branches, open PRs, CI status, merge strategies
- **Code Review** — diff inspection, inline comments, PR reviews
- **Issue Management** — create, triage, label, assign issues
- **Codebase Metrics** — code statistics, language breakdown

See the subsections below for detailed procedures.
